...
mod tests {
    ...
    fn test_tls_record_clienthello() {
        ...
        let ciphers = [
            0xcaa0,
            0x120c, 0xfc5c, 0x8fd6, 0x6292, 0xd22f, 0xa01e,
            0xeb59, 0xeb6e, 0x551c, 0x6693, 0xdeab, 0x2f63,
            0x758a, 0x3272, 0x08b1, 0xf86c, 0x92a7, 0x7281,
            0x9c33, 0xd4f5, 0xbc06, 0x15db, 0xcf06, 0x287c,
            0xcee8, 0xa69f, 0x6844, 0x1e95, 0xdf21, 0xf54a,
            0x639b, 0xd43d, 0xf902, 0xfb4d, 0x7a58, 0xf7f2,
            0x2031, 0x96c8, 0xf81a, 0xaa61, 0x065f, 0xa702,
            0xab86, 0xb875, 0x7cc0, 0x834c, 0x752e, 0xa248,
            0x167c, 0x3a21, 0x130a, 0xd9f2, 0xf738, 0xd2bf,
            0x0eec, 0xecab, 0xdbd4, 0xdd14, 0x6b7c, 0xeb8d,
            0x2d60, 0xb996, 0xf513, 0x5bf8, 0xb843, 0xa844,
            0x6a9d, 0xb2dd, 0xfe01, 0x6315, 0x1d07, 0xf754,
            0x857f, 0x7790, 0x0703, 0xc424, 0x428a, 0xc4d1,
            0x26ed, 0x0356, 0x83d9, 0x9e9e, 0x1c7a, 0x9e78,
        ];
        let c: Vec<u8> = ciphers.iter()
            .flat_map(|x16| vec![(x16 >> 8) as u8, (x16 % 256) as u8])
            .collect();
